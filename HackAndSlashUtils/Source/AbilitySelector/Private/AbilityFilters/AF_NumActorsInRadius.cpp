#include "AbilityFilters/AF_NumActorsInRadius.h"
#include "AbilityFilterData.h"

bool UAF_NumActorsInRadius::CanPassFilter_Implementation(UAbilityFilterData* data) const
{
	check(data);
	...
	return actors_in_radius->m_actors.Num() >= m_actor_count;
}
